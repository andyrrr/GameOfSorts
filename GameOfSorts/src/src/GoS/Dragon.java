...
public class Dragon {
	...
	/**
	 * Se crea un objeto dragón con sus distintos atributos, el constructor recibe
	 * las listas con los dato usados o a usar
	 * 
	...
	/**
	 * Toma el tamaño de la lisa, toma una posición aleatoria, toma el valor de la
	 * posición se la asigna al nombre y elimina ese dato asinado de la lista a usar
	 * 
	...
	/**
	 * Toma el tamaño de la lisa, toma una posición aleatoria, toma el valor de la
	 * posición se la asigna al apellido y elimina ese dato asinado de la lista a
	 * usar
	 * 
	 * @param apellidos
	 */
	...
	/**
	 * Toma un número aleatorio de 1 a 100 y se lo asigna al objeto como velocidade
	 * de recarga
	 */
	...
	/**
	 * Toma el tamaño de la istal, escoge una posición al azar se le define el valor
	 * de esta posición la edad del objeto
	 * 
	...
	/**
	 * Se toma un número al azar entre 1 y 3 y se le define como la resistencia de
	 * cada dragón a ser atacado
	 */
